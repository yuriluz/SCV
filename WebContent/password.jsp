	...
	<div class="w3-container w3-margin-top w3-padding-64">
		<div class="w3-card-2 w3-white w3-display-middle w3-margin-top w3-animate-opacity" style="width: 80%; max-width: 420px;" id="access">
			<header class="w3-container w3-yellow">
				<h3 class="w3-center">RECUPERAÇÃO DE SENHA</h3>
			</header>
			<div class="w3-padding">
				...
				<input type="hidden" id="tipo" name="tipo" value="<%=tipo%>">
					...
					<div>
						<p>
							<input class="w3-input w3-border" type="text" id="doc" name="doc" placeholder="Endereço de e-mail" autocomplete="off" required>
						</p>
					</div>
					<div class="w3-center">
						<p>
